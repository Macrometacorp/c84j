 ...
 * 
 * @see <a href="https://docs.c8db.com/current/AQL/Graphs/Traversals.html">Graph traversals in AQL</a>
 * 
 * @author a-brandt
 *
 */
public class GraphTraversalsInC8QLExample extends BaseGraphTest {

	@Test
	public void queryAllVertices() throws C8DBException {
		String queryString = "FOR v IN 1..3 OUTBOUND 'circles/A' GRAPH 'traversalGraph' RETURN v._key";
		C8Cursor<String> cursor = db.query(queryString, null, null, String.class);
	...
	@Test
	public void queryDepthTwo() throws C8DBException {
	...
	@Test
	public void queryWithFilter() throws C8DBException {
	...
	@Test
	public void queryOutboundInbound() throws C8DBException {
