 ...
 * 
 * @see <a href="https://docs.c8db.com/current/cookbook/Graph/ExampleActorsAndMovies.html">AQL Example Queries on an
 *      Actors and Movies Database</a>
 *
 */
public class C8QLActorsAndMoviesExample {
	...
	/**
	 * @see <a href=
	 *      "https://docs.c8db.com/current/cookbook/Graph/ExampleActorsAndMovies.html#all-actors-who-acted-in-movie1-or-movie2">AQL
	...
	/**
	 * @see <a href=
	 *      "https://docs.c8db.com/current/cookbook/Graph/ExampleActorsAndMovies.html#all-actors-who-acted-in-both-movie1-and-movie2-">AQL
	 *      Example Queries on an Actors and Movies Database</a>
	 */
	@Test
	...
	/**
	 * @see <a href=
	 *      "https://docs.c8db.com/current/cookbook/Graph/ExampleActorsAndMovies.html#all-common-movies-between-actor1-and-actor2-">AQL
	 *      Example Queries on an Actors and Movies Database</a>
	 */
	@Test
	...
	/**
	 * @see <a href=
	 *      "https://docs.c8db.com/current/cookbook/Graph/ExampleActorsAndMovies.html#all-actors-who-acted-in-3-or-more-movies-">AQL
	 *      Example Queries on an Actors and Movies Database</a>
	 */
	@Test
	...
	/**
	 * @see <a href=
	 *      "https://docs.c8db.com/current/cookbook/Graph/ExampleActorsAndMovies.html#all-movies-where-exactly-6-actors-acted-in-">AQL
	 *      Example Queries on an Actors and Movies Database</a>
	 */
	@Test
	...
	/**
	 * @see <a href=
	 *      "https://docs.c8db.com/current/cookbook/Graph/ExampleActorsAndMovies.html#the-number-of-actors-by-movie-">AQL
	 *      Example Queries on an Actors and Movies Database</a>
	 */
	@Test
	...
	/**
	 * @see <a href=
	 *      "https://docs.c8db.com/current/cookbook/Graph/ExampleActorsAndMovies.html#the-number-of-movies-by-actor-">AQL
	 *      Example Queries on an Actors and Movies Database</a>
	 */
	@Test
	...
	/**
	 * @see <a href=
	 *      "https://docs.c8db.com/current/cookbook/Graph/ExampleActorsAndMovies.html#the-number-of-movies-acted-in-between-2005-and-2010-by-actor-">AQL
	 *      Example Queries on an Actors and Movies Database</a>
	 */
	@Test
