...
public class SslExample {
	 ...
	 * keytool -import -alias "my c8db server cert" -file UnitTests/server.pem -keystore example.truststore
	 * 
	 * Documentation:
	...
	public void connect() throws Exception {
		...
		final C8DB c8DB = new C8DB.Builder()
				.loadProperties(SslExample.class.getResourceAsStream("/c8db-ssl.properties")).useSsl(true)
				.sslContext(sc).build();
