...
public class C8DBEdgeCollectionTest extends BaseTest {
    ...
    public C8DBEdgeCollectionTest(final Builder builder) {
        super(builder);
    }
    ...
    public void insertEdgeViolatingUniqueConstraint() {
        ...
        db.collection(EDGE_COLLECTION_NAME).ensureSkiplistIndex(Arrays.asList("_from", "_to"),
