...
public class C8DocumentUtilTest {
    ...
    private void checkDocumentKey(final String key) throws C8DBException {
    ...
    private void checkDocumentId(final String id) throws C8DBException {
