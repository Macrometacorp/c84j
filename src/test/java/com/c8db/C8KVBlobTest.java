...
public class C8KVBlobTest extends BaseTest {
    ...
    public void test1_create_KV_collection() {
        ...
        C8KeyValue.C8KVCreateOptions options = new C8KeyValue.C8KVCreateOptions()
                // enable blobs
                .blobs(true)
                .waitForSync(true);
    ...
    public void test2_get_not_exiting_KV_pairs() {
        ...
        C8KeyValue.C8KVReadValuesOptions options = new C8KeyValue.C8KVReadValuesOptions().keys(Arrays.asList("key1"));
    ...
    public void test4_get_blob_and_base_KV_pairs() {
        ...
        C8KeyValue.C8KVReadValuesOptions options = new C8KeyValue.C8KVReadValuesOptions().keys(Arrays.asList("key1","key2","key3"));
        MultiDocumentEntity<BlobKeyValue> result = kvColl.getBlobKVPairs(options);
