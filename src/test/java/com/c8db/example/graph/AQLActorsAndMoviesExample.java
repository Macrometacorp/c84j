...
public class AQLActorsAndMoviesExample {
    ...
    public void allActorsActsInMovie1or2() {
        final C8Cursor<String> cursor = db.query(
    ...
    public void allActorsWhoActedIn3orMoreMovies() {
        final C8Cursor<Actor> cursor = db.query(
    ...
    public void theNumberOfActorsByMovie() {
        final C8Cursor<Movie> cursor = db.query(
    ...
    public void theNumberOfMoviesByActor() {
        ...
        assertThat(cursor.asListRemaining(),
                hasItems(new Actor("actors/Al", 1), new Actor("actors/AnnabellaS", 1), new Actor("actors/AnthonyE", 1),
                        ...
                        new Actor("actors/Charlize", 1), new Actor("actors/ChristopherG", 1),
                        new Actor("actors/CoreyF", 1), new Actor("actors/CubaG", 4), new Actor("actors/DaveC", 1),
                        new Actor("actors/DemiM", 1), new Actor("actors/Emil", 1), new Actor("actors/EthanH", 1),
                        new Actor("actors/GregK", 2), new Actor("actors/HelenH", 1), new Actor("actors/Hugo", 3),
                        new Actor("actors/JackN", 2), new Actor("actors/JamesC", 1), new Actor("actors/JamesM", 1),
                        new Actor("actors/JayM", 1), new Actor("actors/JerryO", 2), new Actor("actors/JohnC", 1),
                        new Actor("actors/JonathanL", 1), new Actor("actors/JTW", 1), new Actor("actors/Keanu", 4),
                        new Actor("actors/KellyM", 1), new Actor("actors/KellyP", 1), new Actor("actors/KevinB", 1),
                        new Actor("actors/KevinP", 1), new Actor("actors/KieferS", 2), new Actor("actors/Laurence", 3),
                        new Actor("actors/MarshallB", 1), new Actor("actors/MaxS", 2), new Actor("actors/MegR", 5),
                        new Actor("actors/Nathan", 1), new Actor("actors/NoahW", 1), new Actor("actors/ParkerP", 1),
                        new Actor("actors/ReginaK", 1), new Actor("actors/ReneeZ", 1), new Actor("actors/RickY", 1),
                        new Actor("actors/RitaW", 1), new Actor("actors/RiverP", 1), new Actor("actors/Robin", 1),
                        new Actor("actors/RosieO", 1), new Actor("actors/SteveZ", 1), new Actor("actors/TomC", 3),
                        new Actor("actors/TomH", 3), new Actor("actors/TomS", 1), new Actor("actors/ValK", 1),
                        new Actor("actors/VictorG", 1), new Actor("actors/WernerH", 1), new Actor("actors/WilW", 1)));
    }
    ...
    private static DocumentCreateEntity<BaseDocument> saveMovie(final C8Collection movies, final String key,
            final String title, final int released, final String tagline) {
    ...
    private static DocumentCreateEntity<BaseDocument> saveActor(final C8Collection actors, final String key,
            final String name, final int born) {
        final BaseDocument value = new BaseDocument();
        value.setKey(key);
    ...
    private static DocumentCreateEntity<BaseEdgeDocument> saveActsIn(final C8Collection actsIn, final String actor,
            final String movie, final String[] roles, final int year) {
    ...
    private static void createData() {
        ...
        final C8Collection actors = db.collection("actors");
        db.createCollection("movies");
        final C8Collection movies = db.collection("movies");
        db.createCollection("actsIn", new CollectionCreateOptions().type(CollectionType.EDGES));
        final C8Collection actsIn = db.collection("actsIn");
