...
public interface C8Database extends C8SerializationAccessor {
    ...
    /**
     * Executes a query worker with the given {@code name} and
     * {@code bindVars}, then returns a new {@code C8Cursor} instance.
     * If {@code userName} is null then it tries to execute for the current user.
     *
