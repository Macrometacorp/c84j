...
public interface C8Serializer {
    ...
    class Options {
        ...
        /**
         * 
         * @param additionalFields Additional Key/Value pairs to include in the created
         *                         VelocyPack.
         * @return options
         */
     ...
     * 
     * @param entity The Object to serialize. If it is from type String, it will be
     *               handled as a JSON.
     * @return The serialized VelocyPack
     * @throws C8DBException
     */
    VPackSlice serialize(final Object entity) throws C8DBException;
     ...
     * @throws C8DBException
     */
    VPackSlice serialize(final Object entity, final Options options) throws C8DBException;
