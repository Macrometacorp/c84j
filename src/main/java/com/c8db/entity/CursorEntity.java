...
public class CursorEntity<T> implements Entity, MetaAware {
    ...
    /**
     * @return the total number of result documents available (only available if the
    ...
    /**
     * @return an optional object with extra information about the query result
    ...
    /**
     * @return a boolean flag indicating whether the query result was served from
     *         the query cache or not. If the query result is served from the query
    ...
    /**
     * @return A boolean indicator whether there are more results available for the
    ...
    /**
     * @return an vpack-array of result documents (might be empty if query has no
     *         results)
     */
