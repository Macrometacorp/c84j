...
public class CollectionPropertiesEntity extends CollectionEntity {
    ...
    /**
     * @return the number of shards of the collection. Only in a cluster setup (else
     *         returning null).
     */
    ...
    /**
     * @return the names of document attributes that are used to determine the
     *         target shard for documents. Only in a cluster setup (else returning
     *         null).
     */
    ...
    /**
     * @return whether the collection is a satellite collection. Only in an
     *         enterprise cluster setup (else returning null).
     */
