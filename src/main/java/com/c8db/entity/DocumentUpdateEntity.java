...
public class DocumentUpdateEntity<T> extends DocumentEntity {
    ...
    /**
     * @return If the query parameter returnNew is true, then the complete new
    ...
    /**
     * @return If the query parameter returnOld is true, then the complete previous
     *         revision of the document is returned.
     */
    public T getOld() {
        return oldDocument;
    }
