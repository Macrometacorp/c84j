...
public interface C8Collection extends C8SerializationAccessor {
     ...
     * @throws C8DBException
     * @see <a href=
     *      "https://docs.arangodb.com/current/HTTP/Indexes/Hash.html#create-hash-index">API
     *      Documentation</a>
     */
     ...
     * @throws C8DBException
     * @see <a href=
     *      "https://docs.arangodb.com/current/HTTP/Indexes/Skiplist.html#create-skip-list">API
     *      Documentation</a>
     */
     ...
     * @throws C8DBException
     * @see <a href=
     *      "https://docs.arangodb.com/current/HTTP/Indexes/Persistent.html#create-a-persistent-index">API
     *      Documentation</a>
     */
     ...
     * @throws C8DBException
     * @see <a href=
     *      "https://docs.arangodb.com/current/HTTP/Indexes/Geo.html#create-geospatial-index">API
     *      Documentation</a>
     */
     ...
     * @throws C8DBException
     * @see <a href=
     *      "https://docs.arangodb.com/current/HTTP/Indexes/Fulltext.html#create-fulltext-index">API
     *      Documentation</a>
     */
