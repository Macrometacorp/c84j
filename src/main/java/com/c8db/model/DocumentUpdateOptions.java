...
public class DocumentUpdateOptions {
    ...
    /**
     * @param keepNull If the intention is to delete existing attributes with the
     *                 patch command, the URL query parameter keepNull can be used
     *                 with a value of false. This will modify the behavior of the
     *                 patch command to remove any attributes from the existing
     *                 document that are contained in the patch document with an
    ...
    /**
     * @param mergeObjects Controls whether objects (not arrays) will be merged if
     *                     present in both the existing and the patch document. If
     *                     set to false, the value in the patch document will
     *                     overwrite the existing document's value. If set to true,
     ...
     *                   as a precondition. The document is only updated if the
    ...
    /**
     * @param serializeNull By default, or if this is set to true, all fields of the
     *                      document which have null values are serialized to
     *                      VelocyPack otherwise they are excluded from
     *                      serialization. Use this to update single fields from a
     *                      stored document.
     * @return options
     */
