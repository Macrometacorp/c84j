...
import com.c8.internal.util.CURLLogger;
import com.c8.internal.util.IOUtils;
import com.c8.internal.util.ResponseUtils;
import com.c8.util.C8Serialization;
import com.c8.util.C8Serializer.Options;
...
public class HttpConnection implements Connection {
	...
	private HttpConnection(final HostDescription host, final Integer timeout, final String user, final String password,
		final Boolean useSsl, final SSLContext sslContext, final C8Serialization util, final Protocol contentType,
		final Long ttl) {
		super();
		this.host = host;
		this.user = user;
