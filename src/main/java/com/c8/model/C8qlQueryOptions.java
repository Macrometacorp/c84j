...
public class C8qlQueryOptions implements Serializable {
	 ...
	 * @return options
	 */
	public C8qlQueryOptions ttl(final Integer ttl) {
		this.ttl = ttl;
		return this;
	}
	 ...
	 * @return options
	 */
	public C8qlQueryOptions batchSize(final Integer batchSize) {
	 ...
	 * @return options
	 */
	public C8qlQueryOptions memoryLimit(final Long memoryLimit) {
	 ...
	 * @return options
	 */
	public C8qlQueryOptions failOnWarning(final Boolean failOnWarning) {
	 ...
	 * @return options
	 */
	public C8qlQueryOptions maxTransactionSize(final Long maxTransactionSize) {
	 ...
	 * @return options
	 */
	public C8qlQueryOptions maxWarningCount(final Long maxWarningCount) {
	 ...
	 * @return options
	 */
	public C8qlQueryOptions intermediateCommitCount(final Long intermediateCommitCount) {
	 ...
	 * @return options
	 */
	public C8qlQueryOptions intermediateCommitSize(final Long intermediateCommitSize) {
	 ...
	 * @return options
	 */
	public C8qlQueryOptions satelliteSyncWait(final Double satelliteSyncWait) {
	 ...
	 * @return options
	 */
	public C8qlQueryOptions skipInaccessibleCollections(final Boolean skipInaccessibleCollections) {
	 ...
	 * @return options
	 */
	public C8qlQueryOptions fullCount(final Boolean fullCount) {
	 ...
	 * @return options
	 */
	public C8qlQueryOptions maxPlans(final Integer maxPlans) {
	 ...
	 *            enough), or stored on the c8d instance and accessible via the cursor API (with respect to the
	 ...
	 * @return options
	 */
	public C8qlQueryOptions stream(final Boolean stream) {
	 ...
	 * @return options
	 */
	public C8qlQueryOptions shardIds(final String... shardIds) {
	...
	/**
	 * @see <a href="https://docs.c8db.com/current/Manual/Administration/ActiveFailover/#reading-from-follower">API
	 *      Documentation</a>
	 ...
	 * @return options
	 */
	public C8qlQueryOptions allowDirtyRead(final Boolean allowDirtyRead) {
