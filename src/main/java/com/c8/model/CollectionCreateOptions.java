...
import com.c8.entity.KeyOptions;
import com.c8.entity.KeyType;
...
public class CollectionCreateOptions {
	 ...
	 *            be slightly faster than regular collections because C8DB does not enforce any synchronization to
	 ...
	 *            this value, but other index types might follow in future C8DB versions. Changes (see below) are
