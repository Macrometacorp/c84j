 ...
 * 
 * @see <a href="https://docs.c8db.com/current/HTTP/AqlQuery/index.html#explain-an-aql-query">API Documentation</a>
 */
public class C8qlQueryExplainOptions {
	 ...
	 * @return options
	 */
	protected C8qlQueryExplainOptions bindVars(final Map<String, Object> bindVars) {
