 ...
 *
 */
public class C8SearchPropertiesOptions {

	private final C8SearchProperties properties;

	public C8SearchPropertiesOptions() {
		super();
		properties = new C8SearchProperties();
	}

	public C8SearchProperties getProperties() {
		return properties;
	}
	 ...
	 * @return options
	 */
	public C8SearchPropertiesOptions consolidationIntervalMsec(final Long consolidationIntervalMsec) {
	 ...
	 * @return options
	 */
	public C8SearchPropertiesOptions cleanupIntervalStep(final Long cleanupIntervalStep) {
	 ...
	 * @return options
	 */
	public C8SearchPropertiesOptions consolidationPolicy(final ConsolidationPolicy consolidationPolicy) {
	 ...
	 * @return options
	 */
	public C8SearchPropertiesOptions link(final CollectionLink... links) {
