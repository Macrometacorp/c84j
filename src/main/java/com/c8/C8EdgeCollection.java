 ...
 * 
 * @see <a href="https://docs.c8db.com/current/HTTP/Gharial/Edges.html">API Documentation</a>
...
public interface C8EdgeCollection extends C8SerializationAccessor {
	 ...
	 * 
	 * @see <a href="https://docs.c8db.com/current/HTTP/Gharial/Edges.html#create-an-edge">API Documentation</a>
	 * @param value
	 ...
	 * 
	 * @see <a href="https://docs.c8db.com/current/HTTP/Gharial/Edges.html#get-an-edge">API Documentation</a>
	 * @param key
	 *            The key of the edge
	 * @param type
	 ...
	 * @throws C8DBException
	 */
	<T> T getEdge(String key, Class<T> type, DocumentReadOptions options) throws C8DBException;

	/**
	 * Replaces the edge with key with the one in the body, provided there is such a edge and no precondition is
	 * violated
	 * 
	 * @see <a href="https://docs.c8db.com/current/HTTP/Gharial/Edges.html#replace-an-edge">API Documentation</a>
	 * @param key
	 *            The key of the edge
	 * @param type
	 *            The type of the edge-document (POJO class, VPackSlice or String for JSON)
